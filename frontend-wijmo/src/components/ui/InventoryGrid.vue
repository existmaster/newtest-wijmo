<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','productId','price','purchaseAmount','purchaseDate',]" />
            <wj-flex-grid-cell-template cellType="RowHeader" v-slot="cell">{{cell.row.index + 1}}</wj-flex-grid-cell-template>
            <wj-flex-grid-column binding="productId" header="상품아이디" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="price" header="가격" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="purchaseAmount" header="매입금액" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="purchaseDate" header="매입일" width="2*" :isReadOnly="true" align="center" />
        </wj-flex-grid>
        <v-col>
            <v-dialog
                v-model="openDialog"
